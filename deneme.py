...
for verileri_cek in oku.fetchall():
    sec =  verileri_cek['sec']
    minu =verileri_cek['minu']
    hour =verileri_cek['hour']
    day =  verileri_cek['day']
    month = verileri_cek['month']
    year = verileri_cek['year']
    tl = verileri_cek['tl']
    ml = verileri_cek['ml']
    loc = verileri_cek['loc']
    gmt = verileri_cek['gmt']
baglanti.commit()
baglanti.close()
pygame.init()
